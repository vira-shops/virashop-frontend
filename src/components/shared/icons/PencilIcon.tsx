...
const PencilIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M22.9399 12H32.9399" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" />
    <path d="M22.9399 36H30.9399" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" />
    <path
      d="M22.9399 27.9L32.9399 28"
      stroke="currentColor"
      strokeWidth={1.5}
      strokeLinecap="round"
    />
    <path d="M22.9399 20H28.9399" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" />
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M16.8801 14H5.06006" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" />
  </svg>
);

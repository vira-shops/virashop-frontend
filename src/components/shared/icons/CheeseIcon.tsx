...
const CheeseIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth={1.5}
    />
    <circle cx={16.75} cy={31.2969} r={3.25} stroke="#222222" strokeWidth={1.5} />
    <circle cx={24.25} cy={17.7969} r={1.75} stroke="#222222" strokeWidth={1.5} />
    <circle cx={40.25} cy={30.7969} r={1.75} stroke="#222222" strokeWidth={1.5} />
  </svg>
);

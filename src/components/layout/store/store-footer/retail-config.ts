...
/** Footer ribbon scrolls back to the retail promo slider. */
const RETAIL_SCROLL_TARGET_ID = 'promo-slider';

export const retailStoreFooterConfig: StoreFooterConfig = {
  features: [
  ...
  scrollTargetId: RETAIL_SCROLL_TARGET_ID,
};
